...
DHomeview ::DHomeview()
{
  ...
  //账户
    ...
    this->scene.addItem(button_account);
    ...
    this->scene.addItem(item_acount);
    ...
    this->scene.addItem(button_display);
    ...
    this->scene.addItem(item_display);
    ...
    this->scene.addItem(button_default);
    ...
    this->scene.addItem(item_default);
    //个性化
    ...
    this->scene.addItem(button_personalization);
    ...
    this->scene.addItem(item_personalization);
    //网络
    ...
    this->scene.addItem(button_network);
    ...
    this->scene.addItem(item_network);
    //声音
    ...
    this->scene.addItem(button_sound);
    ...
    this->scene.addItem(button_date);
    ...
    this->scene.addItem(button_power);
    ...
    this->scene.addItem(item_power_control);
    //鼠标
    ...
    this->scene.addItem(button_mouse);
    ...
    this->scene.addItem(button_keyboard);
    ...
    this->scene.addItem(item_keyboard);
    ...
    this->scene.addItem(button_shortcuts);
    ...
    this->scene.addItem(item_shortcuts);
    //启动菜单
    ...
    this->scene.addItem(button_menu);
    ...
    this->scene.addItem(button_system);
    ...
    this->scene.addItem(item_system);
    //电源按钮
    ...
    dimage->setPos(0,315);
    this->scene.addItem(dimage);
    this->scene.addItem(powerButton);
    //电源字体显示
    ...
    this->accountScene.addItem(button_home1);
    ...
    this->accountScene.addItem(button_account1);
    ...
    this->accountScene.addItem(button_display1);
    ...
    this->accountScene.addItem(button_default1);
    ...
    this->accountScene.addItem(button_personalization1);
    ...
    this->accountScene.addItem(button_network1);
    ...
    this->accountScene.addItem(button_sound1);
    ...
    this->accountScene.addItem(button_date1);
    ...
    this->accountScene.addItem(button_power1);
    ...
    this->accountScene.addItem(button_mouse1);
    ...
    this->accountScene.addItem(button_keyboard1);
    ...
    this->accountScene.addItem(button_shortcuts1);
    ...
    this->accountScene.addItem(button_menu1);
    ...
    this->accountScene.addItem(button_system1);
    ...
    this->accountScene.addItem(button_pow);
...
//侧边栏显示界面
    ...
    this->displayScene.addItem(button_home2);
    ...
    this->displayScene.addItem(button_account2);
    ...
    this->displayScene.addItem(button_display2);
    ...
    this->displayScene.addItem(button_default2);
    ...
    this->displayScene.addItem(button_personalization2);
    ...
    this->displayScene.addItem(button_network2);
    ...
    this->displayScene.addItem(button_sound2);
    ...
    this->displayScene.addItem(button_date2);
    ...
    this->displayScene.addItem(button_power2);
    ...
    this->displayScene.addItem(button_mouse2);
    ...
    this->displayScene.addItem(button_keyboard2);
    ...
    this->displayScene.addItem(button_shortcuts2);
    ...
    this->displayScene.addItem(button_menu2);
    ...
    this->displayScene.addItem(button_system2);
    ...
    this->displayScene.addItem(button_pow2);

    this->displayScene.addLine(-100,-290,200,-290);
    ...
    this->displayScene.addItem(display);
   ...
   // displayreset->boundImageToPress(pressIcon[15]);
    ...
    this->displayScene.addItem(displayreset);
   ...
   this->defaultScene.addItem(button_home3);
   ...
   this->defaultScene.addItem(button_account3);
   ...
   this->defaultScene.addItem(button_display3);
   ...
   this->defaultScene.addItem(button_default3);
   ...
   this->defaultScene.addItem(button_personalization3);
   ...
   this->defaultScene.addItem(button_network3);
   ...
   this->defaultScene.addItem(button_sound3);
   ...
   this->defaultScene.addItem(button_date3);
   ...
   this->defaultScene.addItem(button_power3);
   ...
   this->defaultScene.addItem(button_mouse3);
   ...
   this->defaultScene.addItem(button_keyboard3);
   ...
   this->defaultScene.addItem(button_shortcuts3);
   ...
   this->defaultScene.addItem(button_menu3);
   ...
   this->defaultScene.addItem(button_system3);
   ...
   this->defaultScene.addItem(button_pow3);
   ...
   this->personalizationScene.addItem(button_home4);
   ...
   this->personalizationScene.addItem(button_account4);
   ...
   this->personalizationScene.addItem(button_display4);
   ...
   this->personalizationScene.addItem(button_default4);
   ...
   this->personalizationScene.addItem(button_personalization4);
   ...
   this->personalizationScene.addItem(button_network4);
   ...
   this->personalizationScene.addItem(button_sound4);
   ...
   this->personalizationScene.addItem(button_date4);
   ...
   this->personalizationScene.addItem(button_power4);
   ...
   this->personalizationScene.addItem(button_mouse4);
   ...
   this->personalizationScene.addItem(button_keyboard4);
   ...
   this->personalizationScene.addItem(button_shortcuts4);
   ...
   this->personalizationScene.addItem(button_menu4);
   ...
   this->personalizationScene.addItem(button_system4);
   ...
   this->personalizationScene.addItem(button_pow4);
   ...
   this->soundScene.addItem(button_pow6);
     ...
     button_account10->connect(button_account8,SIGNAL(fireAction()),this,SLOT(account()));
     ...
     button_sound10->connect(button_sound8,SIGNAL(fireAction()),this,SLOT(sound()));
